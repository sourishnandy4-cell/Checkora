...
const bots = [
  { id: 'pragg', name: 'Praggnanandhaa', query: 'Rameshbabu_Praggnanandhaa' },
  { id: 'mamta-banarjee', name: 'Mamata Banerjee', query: 'Mamata_Banerjee' },
  { id: 'judit-polgar', name: 'Judit Polgar', query: 'Judit_Polgár' }
];
